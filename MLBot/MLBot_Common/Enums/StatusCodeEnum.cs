...
namespace MLBot.Enums
{
    ...
    public enum StatusCodeEnum
    {
        ...
        /// </summary>
        [Description("商品原因失败")]
        FAILGOODS_Precondition = -2001412,
        /// <summary>
        /// 余额未满足前置条件
        /// </summary>
        [Description("余额未满足前置条件")]
        FAILBALANCE_Precondition = -2002412,
        /// <summary>
        /// 微信昵称有误
        /// </summary>
        [Description("微信昵称有误")]
        FAILWEIXINNICKNAME_Precondition = -2003412,
        /// <summary>
        /// 通道未添加
        /// </summary>
        [Description("通道未添加")]
        FAILPASSAGE_Precondition = -2004412,
        #endregion
