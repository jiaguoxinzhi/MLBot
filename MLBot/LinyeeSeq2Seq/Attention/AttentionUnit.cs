...
namespace LinyeeSeq2Seq
{
    ...
    public class LinyeeUnit
    {
        ...
        //public LinyeeUnit(Seq2SeqLearn.AttentionUnit unit) : this(unit.batchSize)
        //{
        //    MaxIndex = unit.MaxIndex;
        //    V = new WeightMatrix(unit.V);
        //    Ua = new WeightMatrix(unit.Ua);
        //    bUa = new WeightMatrix(unit.bUa);
        //    Wa = new WeightMatrix(unit.Wa);
        //    bWa = new WeightMatrix(unit.bWa);
        //}
